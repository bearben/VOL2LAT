...
(assert
 (let ((?x5163 (- symbol_0 symbol_0)))
 (let ((?x6110 (- ?x5163 symbol_0)))
 (let ((?x8684 (- ?x6110 symbol_0)))
 (let ((?x1177 (- ?x8684 symbol_0)))
 (>= (- ?x1177 symbol_0) symbol_0))))))
(assert
